	    ...
	    <div class="span7">
	        ...
	        <div class="aqua-panel">
	            <div class="aqua-panel-header">
	                ...
	                <h2>Change password (affiliation control panel only)<span></span></h2>
	            ...
	            <div class="aqua-panel-content">
					...
					<html:form action="/password/save" styleClass="well form-horizontal" styleId="horizontalForm" method="post">
						<fieldset>
							
							<div class="control-group ">
								<label class="control-label" for="Form_previousPassword" style="width: 245px;">Previous password</label>
								<div class="controls" style="line-height:30px;margin-left: 270px;">
									<html:password property="previousPassword" styleId="Form_previousPassword"  maxlength="256" />
									<logic:messagesPresent property="previousPassword">
										<br/>
										<span class="label label-important">
											<html:errors property="previousPassword"/>
										</span>
							...
							<div class="control-group ">
								<label class="control-label" for="Form_repeatPassword" style="width: 245px;">Repeat new password</label>
								<div class="controls" style="line-height:30px;margin-left: 270px;">
									<html:password property="repeatPassword" styleId="Form_repeatPassword"  maxlength="256" />
									<logic:messagesPresent property="repeatPassword">
										<br/>
										<span class="label label-important">
