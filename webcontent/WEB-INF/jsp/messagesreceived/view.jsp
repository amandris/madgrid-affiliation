    ...
    <div class="span7">
        ...
        <div class="aqua-panel">
            <div class="aqua-panel-header">
                ...
                <h2>Received message from admin<span></span></h2>
            ...
            <div class="aqua-panel-content">
                <div id="user-grid" class="grid-view">
                	<strong>Date:</strong>
					<div class="well">
						<fmt:formatDate value="${messageReceived.created}" pattern="EEEE, dd MMMM yyyy HH:mm:ss"/>
					</div>
					<strong>Subject:</strong>
					<div class="well">
						<c:out value="${messageReceived.subject}"/>
					</div>
					<strong>Message:</strong>
					<div class="well">
						<c:out value="${messageReceived.message}"/>
					</div>

					<div class="form-actions">
						<a href="<html:rewrite page="/do/message/edit"/>?id=<c:out value="${messageReceived.id}"/>" class="btn btn-primary" >Reply</a>
