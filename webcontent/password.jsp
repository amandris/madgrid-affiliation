    ...
    <div class="btn-toolbar well" style="text-align: center;background-color: white;">
        ...
        <div class="aqua-panel">
            <div class="aqua-panel-header">
                <i class="modernpics icons32">n</i><span class="panel-divider"></span><h2>Reset password</h2>
                <div class="aqua-panel-tabs-icons pull-right">
                    <a href="#" class="minimize"></a>
                </div>
            </div>
            <div class="aqua-panel-content">
            	<html:form  styleClass="form-inline" styleId="varticalForm" action="/passwordReset1" method="post" onsubmit="return validateEmail();">
                    ...
                    <div class="alert alert-block alert-error" id="varticalForm_es_" style="display:none;">
                        ...
                        <ul>
                            <li>Type a valid email address.</li>
                        </ul>
                    </div>
                    ...
                    <div class="input-prepend">
                        ...
                        <html:text property="email" style="width:310px;" styleId="email"/>
                        <span class="add-on">
                            <a class="modernpics icons24" rel="tooltip" data-placement="left" title="<strong>Note:</strong> The email address you picked when registering in Instantri.ch.">?</a>
                        </span>
                    </div>
                    
                    <hr/>
                    <button class="pull-right btn btn-primary btn-large btn-block"  type="submit" id="_submit" name="_submit">Send</button>
                    <div class="clear"></div>
                </html:form>
            </div>
        </div>
